...
# YH : text 파일을 공백기준(space, enter)으로 split. 결과는 배열에 담긴다.
...
# YH : vocabulary 와 bocabulary_size 를 전달한다.
def build_dataset(words, n_words):
    ...
    for word in words:                  # words == vocabulary
        if word in dictionary:          # word가 dictionary에 존재한다면 (most_common 에 해당)
